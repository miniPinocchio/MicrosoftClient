...
/**
 * @author Created by huiliu on 2018/12/20.
...
public class MarqueeTextView extends LinearLayout {
    ...
    public void setTextArrays(String[] textArrays) {//1.设置数据源；
    ...
    private interface MarqueeTextViewClickListener extends View.OnClickListener {
